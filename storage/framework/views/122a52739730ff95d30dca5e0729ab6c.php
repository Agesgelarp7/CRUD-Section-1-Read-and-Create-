...
<section class="container my-24 mx-auto">
  <form action="<?php echo e(route('books.update', $book->id)); ?>" method="POST"
    ...
    <div class="relative z-0 w-full mb-5 group">
      <input type="text" name="title" id="title" value="<?php echo e(old('title', $book->title)); ?>"
    ...
    <div class="grid md:grid-cols-2 md:gap-6">
      ...
      <div class="relative z-0 w-full mb-5 group">
        <select name="category" id="category"
          class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          required>
          <option value="" disabled <?php echo e(old('category', $book->category_id) ? '' : 'selected'); ?>>Pilih kategori</option>
          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($category->id); ?>" <?php echo e(old('category', $book->category_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
      ...
      <!-- Stock -->
      <div class="relative z-0 w-full mb-5 group">
        <input type="number" name="stock" id="stock" value="<?php echo e(old('stock', $book->stock)); ?>" min="0"
          class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
          placeholder=" " required />
        <label for="stock"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="relative z-0 w-full mb-5 group">
      <textarea name="summary" id="summary" rows="4"
        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
        placeholder=" " required><?php echo e(old('summary', $book->summary)); ?></textarea>
      <label for="summary"
...
<?php echo $__env->make('Layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\library-app\resources\views/books/edit.blade.php ENDPATH**/ ?>