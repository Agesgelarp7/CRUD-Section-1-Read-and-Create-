...
<section class="container my-24 mx-auto">
  ...
  <?php endif; ?>
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 px-20">
        ...
        <div class="relative">
          <a href="#">
          <img class="h-auto max-w-full rounded-lg" src="<?php echo e(asset
          ('storage/' . $book->image)); ?>" alt="">
          </a>
...
<?php echo $__env->make('Layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\library-app\resources\views/books/index.blade.php ENDPATH**/ ?>